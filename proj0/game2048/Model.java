 ...
 *  @author xrl TODO: YOUR NAME HERE
 */
        ...
        for(int i=0;i< b.size();i++)
        {
            for(int j=0;j<b.size();j++)
            {
                if(b.tile(i,j)!=null)
                {
                    ...
                    if(j-1>=0&&b.tile(i,j-1)!=null&&b.tile(i,j).value()==b.tile(i,j-1).value())
                    {
                        tag=true;
                        break;
                    }
                    if(i-1>=0&&b.tile(i-1,j)!=null&&b.tile(i,j).value()==b.tile(i-1,j).value())
                    {
                        tag=true;
                        break;
                    }
